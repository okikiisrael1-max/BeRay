...
const SLIDES = [
  {
    kind: "hook",
    quote: "Being visible is only the beginning.",
    support: "The brands people remember do more than fill a feed.",
    question: "They make every message mean something.",
  },
  {
    kind: "list",
    title: "A product post is not a strategy.",
    intro: "Your audience needs a clear reason to choose you:",
    items: [
      "A problem you solve",
      "A point of view they remember",
      "Proof that earns their trust",
      "A simple next step",
    ],
    footer:
      "Your product deserves more than a sales pitch. Give people a reason to care before you ask them to buy.",
  },
  {
    kind: "brands",
    title: "Great brands sell meaning.",
    body: "The strongest brands do not lead with features alone. They show people what is possible, why it matters, and why it should matter to them.",
    chips: ["Relevance", "Trust", "Distinctiveness", "Action"],
    footer:
      "The result is content that feels less like advertising and more like a reason to believe.",
  },
  {
    kind: "list",
    ...
    items: [
      ...
      "Keep your brand remembered",
    ],
    footer: "When content has a purpose, consistency becomes a growth system instead of a posting routine.",
  },
  {
    kind: "cta",
    title: "Make every post count.",
    body: "Your brand has something worth saying. Let us turn that message into content people notice, trust, and act on.",
    support:
      "beRay brings social media, marketing, and data together so your content is built for more than attention.",
    cta: "Ready to turn attention into action? Let’s talk.",
  },
];
